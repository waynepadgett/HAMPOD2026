...
### Manual Sync from Windows to Pi (preferred method for testing code that has not been committed)
```powershell
...
- This file: `Documentation/Project_Overview_and_Onboarding/2025-12-5-notes.md`
