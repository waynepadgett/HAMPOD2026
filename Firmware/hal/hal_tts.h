 ...
 * For Piper: Checks for piper binary, model file, and starts persistent pipeline.
 * 
 ...
 * @param output_file Optional output file path (for caching). NULL for direct playback.
